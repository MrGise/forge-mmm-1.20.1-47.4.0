...
public class ThingamajigMenu extends AbstractContainerMenu {
    public final ThingamajigBlockEntity blockEntity;
    ...
    public ThingamajigMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.THINGAMAJIG_MENU.get(), containerId);
        checkContainerSize(inv, 4);
        blockEntity = ((ThingamajigBlockEntity) entity);
