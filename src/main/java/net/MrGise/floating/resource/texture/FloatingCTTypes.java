...
// Enum for CTTypes
public enum FloatingCTTypes implements CTType {
    ...
    FloatingCTTypes(int sheetSize, ConnectedTextureBehaviour.ContextRequirement contextRequirement) {
        this.id = mmm(Lang.asId(name()));
