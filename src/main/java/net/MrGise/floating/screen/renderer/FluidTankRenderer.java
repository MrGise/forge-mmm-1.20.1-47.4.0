...
/**
 * CREDIT: <a href="https://github.com/mezz/JustEnoughItems">JEI</a> by mezz
 * Under MIT-License: <a href="https://github.com/mezz/JustEnoughItems/blob/1.19/LICENSE.txt">JEI license</a>
 * Includes major rewrites and methods from:
 * <a href="https://github.com/mezz/JustEnoughItems/blob/1.19/Forge/src/main/java/mezz/jei/forge/platform/FluidHelper.java">github.com/mezz/JustEnoughItems/blob/1.19/Forge/src/main/java/mezz/jei/forge/platform/FluidHelper.java</a>
 */
    ...
    public List<Component> getTooltip(FluidStack fluidStack, TooltipFlag tooltipFlag) {
        ...
        try {
            ...
            if (tooltipMode == TooltipMode.SHOW_AMOUNT_AND_CAPACITY) {
                MutableComponent amountString = Component.translatable("tooltip.mmm.liquid.amount.with.capacity", nf.format(milliBuckets), nf.format(capacity));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            } else if (tooltipMode == TooltipMode.SHOW_AMOUNT) {
                MutableComponent amountString = Component.translatable("tooltip.mmm.liquid.amount", nf.format(milliBuckets));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            }
        } catch (RuntimeException e) {
            MMM.LOGGER.error("Failed to get tooltip for fluid: " + e);
        }
